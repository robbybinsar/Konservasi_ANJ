...
|                | Richness_index|
|:---------------|--------------:|
|Sempadan_sungai |       3.747046|
|Hutan_balok     |       2.929407|
|Konservasi_KBKT |       3.664858|

```r
make.sorted.plot(richness_index@index)
```

![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
|                | rarefaction|
|:---------------|-----------:|
|Sempadan_sungai |    16.16292|
|Hutan_balok     |    13.86026|
|Konservasi_KBKT |    15.32555|
...
|                | diversity_index|
|:---------------|---------------:|
|Sempadan_sungai |        2.561298|
|Hutan_balok     |        2.355787|
|Konservasi_KBKT |        2.490580|

```r
make.sorted.plot(heterogeneity@index)
```

![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
|                | evenness_index|
|:---------------|--------------:|
|Sempadan_sungai |      0.8412809|
|Hutan_balok     |      0.8699199|
|Konservasi_KBKT |      0.8057411|

```r
make.sorted.plot(evenness_index@index)
```

![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](diversity_measures_SMM_2016_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
