...
|                | Cervus unicolor| Manis javanica| Muntianus muntjak| Ratufa affinis| Trachypitechus auratus| Tarsius bancanus ssp. Saltator| Tragulus napu| Trachypitechus cristatus| Presbytis melalophos| Alcedo coerulescens| Ceyx ruridorsa| Egretta alba| Egrretta intermedia| Halcyon coromanda| Halcyon smyrnenis| Haliaeetus leucogaster| Ictinaetus malayensis| Nectarinia jugularis| Pitta sordida| Spilornis cheela| Acicipiter gularis| Anthracoceros malayanus| Arachnotera longilostra| Arachnotera robusta| Elanus caeruleus| Pitta moluccensis| Pelargopsis capensis| Loriculus galgulus| Psipologon raflesii| Nisaetus nanus| Egretta eulophotes| Tringa flavipes| Butastur indicus| Leptoptilos javanicus | Clamator coromandus| Gracula religiosa| Anthreptes simplex| Alcedo meninting| Bubulcus ibis| Egretta sacra| Egretta garzeta| Ichthyophaga ichthyaetus| Actenoides concretus| Acridotheres javanicus| Harpactes duvaucelii| Meiglyptes tukki| Psittacula longicauda| Rollulus rouloul| Stachyris maculata| Treron capellei| Phaenicophaeus diardi| Crocodilus porosus| Pteropus vampyrus|
|:---------------|---------------:|--------------:|-----------------:|--------------:|----------------------:|------------------------------:|-------------:|------------------------:|--------------------:|-------------------:|--------------:|------------:|-------------------:|-----------------:|-----------------:|----------------------:|---------------------:|--------------------:|-------------:|----------------:|------------------:|-----------------------:|-----------------------:|-------------------:|----------------:|-----------------:|--------------------:|------------------:|-------------------:|--------------:|------------------:|---------------:|----------------:|----------------------:|-------------------:|-----------------:|------------------:|----------------:|-------------:|-------------:|---------------:|------------------------:|--------------------:|----------------------:|--------------------:|----------------:|---------------------:|----------------:|------------------:|---------------:|---------------------:|------------------:|-----------------:|
|Sempadan_sungai |               0|              0|                 3|              6|                      0|                              0|             0|                       45|                    0|                  10|             24|            9|                   7|                 6|                68|                      5|                     0|                   42|             0|                4|                  5|                       2|                       5|                   0|               16|                 9|                    0|                  0|                   0|              0|                 39|               0|                0|                      7|                   0|                 0|                  0|               17|            40|            17|               8|                        2|                    0|                      6|                    5|               11|                     6|                0|                  5|               0|                     3|                  9|                 7|
|Hutan_balok     |               0|              3|                 0|             19|                      0|                              5|             5|                       54|                    0|                   0|             18|            0|                   0|                 0|                50|                      0|                     6|                    0|             7|                0|                 10|                       6|                       0|                   6|                4|                 0|                   17|                  0|                   0|              0|                  0|               0|                0|                      0|                   0|                10|                  8|               10|             0|             0|               0|                        0|                    2|                      0|                    4|                0|                     0|                6|                  6|               8|                     3|                  0|                 0|
|Konservasi_KBKT |               3|              3|                 4|             10|                      3|                              3|             3|                       73|                    3|                  19|             20|           17|                   0|                 0|               101|                      0|                     5|                   58|            13|               10|                 12|                       0|                      19|                   0|               28|                 5|                   15|                  7|                   6|              8|                 30|               3|                3|                      2|                   2|                 4|                 20|               25|            39|            15|               5|                        0|                    0|                      0|                    0|               20|                     6|                3|                 11|               0|                     0|                  0|                14|
...
|                | Richness_index|
|:---------------|--------------:|
|Sempadan_sungai |       5.077977|
|Hutan_balok     |       3.937537|
|Konservasi_KBKT |       6.175725|

```r
make.sorted.plot(richness_index@index)
```

![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
|                | rarefaction|
|:---------------|-----------:|
|Sempadan_sungai |    19.91997|
|Hutan_balok     |    17.24847|
|Konservasi_KBKT |    21.84566|
...
|                | diversity_index|
|:---------------|---------------:|
|Sempadan_sungai |        3.008852|
|Hutan_balok     |        2.695760|
|Konservasi_KBKT |        3.174623|

```r
make.sorted.plot(heterogeneity@index)
```

![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
|                | evenness_index|
|:---------------|--------------:|
|Sempadan_sungai |      0.8681713|
|Hutan_balok     |      0.8597561|
|Konservasi_KBKT |      0.8548704|

```r
make.sorted.plot(evenness_index@index)
```

![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](diversity_measures_SMM_2020_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
