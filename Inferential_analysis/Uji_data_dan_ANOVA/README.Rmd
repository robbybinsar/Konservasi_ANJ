...
> Please refer to [`Analisis_ANOVA_dan_Uji_lanjut-Anggrek_tanah_(Tinggi).md`](https://github.com/robbybinsar/Konservasi_ANJ/blob/master/Inferential_analysis/Uji_data_dan_ANOVA/Analisis_ANOVA_dan_Uji_lanjut-Anggrek_tanah_(Tinggi).md) for one way ANOVA and post hoc test application on a real case example.
