...
forecast.data <- cmip6_world("CNRM-CM6-1", "126", "2021-2040","bioc", 5, "~/My R/Konservasi_ANJ/species_modelling/output/5_res")
...
tif.files <- list.files(path = "~/My R/Konservasi_ANJ/species_modelling/output/5_res/wc2.1_5m", 
                          pattern = "*.tif$", 
                          full.names = TRUE)
...
```{r}
raster::writeRaster(forecast.presence, paste0("~/My R/Konservasi_ANJ/species_modelling/output/very_new/", names(forecast.data)[1],"PREDICTED.tif"), overwrite = TRUE)
